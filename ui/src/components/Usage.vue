				...
				<div class="col-md-12 col-lg-4 mb-4 mb-lg-0">
					<div class="row">
						...
						<div class="col">
							<p class="text-right">
								<span class="metric"
									>{{ usage.bytesUploaded | prettyBytes }}/{{
					...
					<div class="row">
						...
						<div class="col">
							<p class="text-right">
								<span class="metric"
									>{{
										usage.filesUploaded | toHumanString
									}}/{{
										usage.filesUploadedQuota | toHumanString
									}}</span
								>
							</p>
						</div>
					...
					<div class="row">
						...
						<div class="col">
							<p class="text-right">
								<span class="metric"
									>{{
										usage.bytesDownloaded | prettyBytes
									}}/{{
										usage.bytesDownloadedQuota | prettyBytes
									}}</span
								>
							</p>
						</div>
