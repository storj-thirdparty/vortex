					...
					<div class="row">
						<div class="col">
							<p class="text-small">
								...
								</svg> <strong>Storage</strong>
							</p>
						</div>
						<div class="col">
							<p class="text-right"><span class="metric">{{usage.bytesUploaded | prettyBytes}}/{{this.usage.bytesUploadedQuota | prettyBytes}}</span></p>
						</div>
					</div>
					<div class="progress">
					...
					<div class="row">
						<div class="col">
							<p class="text-small">
								...
								</svg> <strong>Files</strong>
							</p>
						</div>
						<div class="col">
							<p class="text-right"><span class="metric">{{usage.filesUploaded | toHumanString}}/{{usage.filesUploadedQuota | toHumanString}}</span></p>
						</div>
					</div>
					<div class="progress">
					...
					<div class="row">
						<div class="col">
							<p class="text-small">
								...
								</svg> <strong>Bandwidth</strong>
							</p>
						</div>
						<div class="col">
							<p class="text-right"><span class="metric">{{usage.bytesDownloaded | prettyBytes}}/{{usage.bytesDownloadedQuota | prettyBytes}}</span></p>
						</div>
					</div>
					<div class="progress">
