						...
						<table class="table table-hover">
							<thead>
								<tr>
									...
									<th
										v-on:mouseover="
											mouseOverHandler('size')
										"
										v-on:mouseleave="
											mouseLeaveHandler('size')
										"
										v-on:click="sortTable('size')"
										class="table-heading"
										scope="col"
									>
										Size
									...
									<th
										v-on:mouseover="
											mouseOverHandler('date')
										"
										v-on:mouseleave="
											mouseLeaveHandler('date')
										"
										v-on:click="sortTable('date')"
										class="table-heading"
										scope="col"
									>
										Upload Date
									...
									<th class="table-heading" scope="col">
										<div class="dropleft">
											<a
												...
												v-if="areThereFilesToDelete()"
												v-on:click="
													deleteSelectedDropdown
												"
											...
											>
												<div>
													<p
														class="deletion-confirmation px-3 pt-3"
													>
														Are you sure?
													</p>
													<div class="d-flex">
	...
	computed: {
		createFolderEnabled() {
			return (
				...
				[...this.createFolderInput].filter((char) => char === ".")
					.length !== this.createFolderInput.length &&
				this.files.filter(
