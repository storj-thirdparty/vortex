				...
				<div class="container card card-top-flat border-0">
					<div class="row border-bottom px-5 pt-4">
						<div class="col-md-12 col-lg-6">
							<h4 class="mt-4 mt-xl-5 text-center text-lg-left">
								Backup Data with Storj + Duplicati
							</h4>
						</div>
						<div class="col-md-12 col-lg-6 text-center">
							<img
								src="@/assets/duplicati-preview.svg"
								alt="Duplicati"
								class="img-fluid"
							/>
						</div>
					...
					<div class="row p-0 py-4 px-md-5">
						<div class="col-12 col-lg-4 pt-5 px-5 px-md-3">
							...
							<h3>Duplicati</h3>
							<p class="mb-3">
								Free backup software to store encrypted backups
								on Storj.
							</p>
							<a
								href="https://www.duplicati.com/download"
								target="_blank"
								class="btn btn-primary px-5 py-2 mt-2 mb-4"
								>Download</a
							>
							<p>
								<a
						...
						<div class="col-12 col-lg-8 p-5 px-md-3">
							<div class="row mb-4">
								<div class="col text-left">
									<label
										class="label"
										for="stargate-endpoint"
										id="lbl-stargate-endpoint"
										>S3 Compatible Endpoint</label
									>
									<input
										type="text"
						...
						<div class="row px-0 py-5 p-md-5">
							<div class="col-12 col-lg-4 pt-5 px-5 px-md-3">
								...
								<div id="docs-nav" class="list-group">
									<a
										href="#docs-1"
										class="docs-link docs-link-active"
										>Add Backup</a
									>
									<a href="#docs-2" class="docs-link"
										>General backup settings</a
									>
									<a href="#docs-3" class="docs-link"
										>Backup destination</a
									>
									<a href="#docs-4" class="docs-link"
										>Source data</a
									>
									<a href="#docs-5" class="docs-link"
										>Run First Backup</a
									>
								</div>
							</div>
							<div class="col-12 col-lg-8 p-5 px-md-3">
								...
								<p>
									Setting up Duplicati encrypted backups on
									Storj only takes 2 minutes. Navigate to
									<b>Add Backup</b> and
									<b>Configure a new Backup</b>. Click Next.
								</p>
								<img
								...
								<p>
									Name your backup, select
									<b>AES-256 encryption, built in</b> for
									encryption, and pick a strong passphrase.
									<i>Note</i> : The backup will still function
									with the <b>No Encryption</b>, however we
									highly recommend you to use the encrypted
									option. Click Next.
								</p>
								<img
								...
								<p>
									For <b>Storage Type</b> select
									<b>S3 Compatible</b>, check <b>Use SSL</b>,
									for <b>Server</b> select
									<b>Custom server url</b>, and copy-paste
									your
									<a
										href="#lbl-stargate-endpoint"
										class="link"
										>S3 Compatible Endpoint</a
									>
									in the input box. Also copy-paste
									<a href="#lbl-bucket" class="link"
										>Bucket</a
									>
									...
									<b>Folder path</b>, but we recommend
								...
								/>
								<p>
									Click <b>Test Connection</b>. When prompted
									if the bucket name should start with your
									username, click <b>No</b>.
								</p>
								<img
								...
								/>
								<p>
									You should see <b>Connection Worked!</b> If
									you see an error, please verify that the
									credentials were copied properly, or
									<a
										href="mailto:vortex@storj.io"
										class="font-weight-bold"
										>contact support</a
									>
									for assistance. Click Next.
								</p>
								<img
								...
								<p>
									Select the folder or folders you would like
									to backup. In our example, we will backup
									our collection of cat pictures. Click Next.
								</p>
								<img
								...
								/>
								<p>
									You can then set a schedule for the backups.
									Click Next.
								</p>
								<img
								...
								<p>
									...
									<b>Backup Retention</b>. We recommend that
									you leave remote volume size as is. Click
									<b>Save</b>.
								</p>
								<img
								...
								/>
								<p>
									You will be reminded to make a safe copy of
									your passphrase.
									<b
										>IF YOU LOSE YOUR PASSPHRASE YOUR DATA
										CANNOT BE RECOVERED</b
									>. So pretty please write it down and/or
									store your passphrase in a safe place.
								</p>
								<img
								...
								<p>
									...
									Duplicati with Storj. You may click
									<b>Run Now</b>, to start your first backup
									job. The backup will occur on the schedule
									that you have set.
								</p>
								<img
