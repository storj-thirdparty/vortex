		...
		<div class="container">
			<ul class="nav nav-tabs nav-justified">
				<li class="nav-item">
					<router-link
						to="/app/browser"
						class="nav-link"
						v-bind:class="tabStyles('/app/browser')"
					>
						<svg
				...
				<li class="nav-item">
					<router-link
						to="/app/apps"
						class="nav-link"
						v-bind:class="tabStyles('/app/apps')"
					>
						<svg
							xmlns="http://www.w3.org/2000/svg"
							width="16"
				...
				<li class="nav-item white-text">
					<router-link
						to="/app/plan"
						class="nav-link"
						v-bind:class="tabStyles('/app/plan')"
					>
						<svg
							xmlns="http://www.w3.org/2000/svg"
							width="16"
			...
			<div class="row">
				<div class="col-sm-12">
					<div
						v-if="
							$store.state.features.emailActivation === true &&
							this.$store.state.activated === false
						"
