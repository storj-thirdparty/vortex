		...
		<div v-if="file.type === 'file'">
			<div class="dropleft">
			  ...
			  <div class="dropdown-menu shadow show" v-if="dropdownOpen">
			    <button class="dropdown-item action p-3" v-on:click="$emit('download'); dropdownOpen = false;">
			    ...
			    <button class="dropdown-item action p-3" v-on:click="share; dropdownOpen = false;">
			    ...
			    <button v-if="!deleteConfirmation" class="dropdown-item action p-3" v-on:click="deleteConfirmation = true">
          		    ...
          		    <button v-else class="dropdown-item action p-3" v-on:click="$emit('delete'); closeDropdown()">
						<svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-x mr-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
							<path fill-rule="evenodd" d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z" />
						</svg>
						Are you sure?
