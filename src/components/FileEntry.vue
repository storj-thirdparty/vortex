		...
		<div v-if="file.type === 'file'">
			<div class="dropleft">
			  ...
			  <div class="dropdown-menu shadow show" v-if="dropdownOpen">
			    <button class="dropdown-item action p-3" href="#" v-on:click="$emit('download'); dropdownOpen = false;">
			    ...
			    <button class="dropdown-item action p-3" href="#" v-on:click="share; dropdownOpen = false;">
			    ...
			    <button v-if="!deleteConfirmation" class="dropdown-item action p-3" href="#" v-on:click="deleteConfirmation = true">
