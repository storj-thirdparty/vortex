...
<template>
<tr scope="row" v-on:click.right="toggleDropdown">
	...
	<td class="text-right">
		<div v-if="file.type === 'file'">
			<div class="dropleft">
				...
				<button v-else class="btn btn-white btn-actions" type="button" aria-haspopup="true" aria-expanded="false">
				...
				<div class="dropdown-menu shadow show" v-if="dropdownOpen" v-on:click.right="toggleDropdown">
